...
df_train = load_dataset('paws', 'labeled_final', split='train') 
df_test = load_dataset('paws', 'labeled_final', split='test') 

#data preparation for fasttext
with open('../../datasets_fasttext/paws.train', 'w', encoding="utf-8") as f:
...
#data preparation for fasttext
with open('../../datasets_fasttext/paws.valid', 'w', encoding="utf-8") as f:
