...
df_train = load_dataset('glue', 'rte', split='train') 
df_test = load_dataset('glue', 'rte', split='validation') 

#data preparation for fasttext
with open('../../datasets_fasttext/rte.train', 'w', encoding="utf-8") as f:
...
#data preparation for fasttext
with open('../../datasets_fasttext/rte.valid', 'w', encoding="utf-8") as f:
